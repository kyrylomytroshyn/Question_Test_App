...
class TestModels(TestCase):
    ...
    def test_project_is_assigned_pk_on_creation(self):
        ...
        self.first_test.questions.add(self.first_question)

        self.assertEquals(self.first_test.questions.all()[0], self.first_question)
    ...
    def test_testrun_is_assigned_pk_on_creation(self):
        ...
        self.assertEquals(self.first_test_run.questions.all()[0], self.first_question)
